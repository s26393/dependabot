 ...
 */
package com.adobe.aem.dependabot.core.models;
...
import com.adobe.aem.dependabot.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "dependabot/components/helloworld");
